...
int height(PNODE root) // считает разницу высот
{
...
PNODE turnLeft(PNODE root) //поворот дерева влево
{
...
PNODE turnRight(PNODE root) //поворот дерева вправо
{
...
PNODE balanceTree(PNODE root) // балансировка дерева
{
    PNODE newRoot = root;
